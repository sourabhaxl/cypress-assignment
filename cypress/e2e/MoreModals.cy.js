...
///Assert modal title
cy.get('#myModal > .modal-dialog > .modal-content > .modal-header').should('contain', 'Modal title')

///Assert the button in modal
cy.get('#myModal > .modal-dialog > .modal-content > .modal-footer > .btn-primary').should('be.visible')
.click()
