export class fillForm {
  validDetails() {
    cy.get(":nth-child(1) > :nth-child(2) > .form-control")
      .focus()
      .type("ValidUserfirstname");
    cy.get(":nth-child(1) > :nth-child(3) > .form-control")
      .focus()
      .type("ValidUserLastname");
    ...
    cy.get("#msdd").click();
    cy.get(".ui-autocomplete > :nth-child(7)").click();
    cy.get(":nth-child(7) > .col-md-3").click();

    cy.get("#Skills").select("Analytics");

    //The country dropdown does not expand
  ...
  invalidDetails() {
    cy.get(":nth-child(1) > :nth-child(2) > .form-control")
      .focus()
      .type("InvalidUserfirstname");
    cy.get(":nth-child(1) > :nth-child(3) > .form-control")
      .focus()
      .type("InvalidUserLastname");
    cy.get(".col-md-8 > .form-control").type("HouseNumber 123, Delhi, India");
